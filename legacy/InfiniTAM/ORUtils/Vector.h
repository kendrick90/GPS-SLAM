...
namespace ORUtils
{
	...
	public:
		...
		_CPU_AND_GPU_CODE_ inline Vector4<unsigned char> toUChar() const
		{
			...
			return Vector4<unsigned char>((unsigned char)CLAMP(vi.x, 0, 255), (unsigned char)CLAMP(vi.y, 0, 255), (unsigned char)CLAMP(vi.z, 0, 255), (unsigned char)CLAMP(vi.w, 0, 255));
		}
	...
	public:
		...
		_CPU_AND_GPU_CODE_ inline Vector6<unsigned char> toUChar() const
		{
			...
			return Vector6<unsigned char>((unsigned char)CLAMP(vi[0], 0, 255), (unsigned char)CLAMP(vi[1], 0, 255), (unsigned char)CLAMP(vi[2], 0, 255), (unsigned char)CLAMP(vi[3], 0, 255), (unsigned char)CLAMP(vi[4], 0, 255), (unsigned char)CLAMP(vi[5], 0, 255));
		}
	...
	public:
		...
		_CPU_AND_GPU_CODE_ explicit VectorX(const T &t)
		{
			for (int i = 0; i < s; i++)
				this->v[i] = t;
		} // Scalar constructor
		...
		_CPU_AND_GPU_CODE_ inline VectorX<unsigned char, s> toUChar() const
		{
			...
			for (int i = 0; i < s; i++)
				retv[i] = (unsigned char)CLAMP(vi[0], 0, 255);
			return retv;
		}
